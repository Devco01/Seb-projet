...
export default function AccueilAlternatif() {
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="mb-8">
        <p className="text-lg mb-4">
          Bienvenue sur votre espace de gestion. Cette page est une version alternative sans connexion à la base de données.
        </p>
